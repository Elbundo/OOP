...
public class AStarState
{
    ...
    public Waypoint getMinOpenWaypoint()
    {
        ...
        for(Location key : open_waypoints.keySet()){
            Waypoint way = open_waypoints.get((Location)key);
            float current_value = way.getTotalCost();
    ...
    public boolean addOpenWaypoint(Waypoint newWP)
    {
        ...
        if(open_waypoints.containsKey(loc)){
            if(open_waypoints.get(loc).getPreviousCost() <= newWP.getPreviousCost()){
                return false;
            }
        }
    ...
    {
        closed_waypoints.put(loc, open_waypoints.get(loc));
        open_waypoints.remove(loc);
    }
